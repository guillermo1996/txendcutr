...
> **Note:** This is a fork of [txcutr](https://github.com/mfansler/txcutr) currently under development. 
> It extends the original package to support both 5' and 3' transcript end truncation, along with performance optimizations.
> See branches `5prime_extension` and `optimizations` for specific changes.
...
This is an active fork with the following branches:
 ...
 - `5prime_extension` - Adds 5' truncation support and overlapped exon export
...
This package is a fork of txcutr by Mervin Fansler. Please cite the original work.
